...
<div class="row">
    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
        <div class="pd-20 card-box height-100-p">
            ...
            <h5 class="text-center h5 mb-0" id="adminProfileName">{{ $seller->name }}</h5>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name='email' id="email" placeholder="Enter email" value="{{ $seller->email }}">
                                                @error('email')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name='username' id="username" placeholder="Enter username" value="{{ $seller->username }}">
                                                @error('username')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group" data-select2-id="7">
                                                ...
                                                <select class="custom-select2 form-control select2-hidden-accessible" name="service1" id="service1" style="width: 100%; height: 38px" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                                    ...
                                                    @foreach ($services as $row )
                                                        <option value="{{ $row->id }}" {{ $row->id == $seller->service1 ? 'selected' : '' }} >{{ $row->title  }}</option>
                                                    @endforeach
                                                </select>
                                                @error('service1')
                                                    <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="col-md-4" data-select2-id="8">
                                            <div class="form-group" data-select2-id="7">
                                                ...
                                                <select class="custom-select2 form-control select2-hidden-accessible" name="service2" id="service2" style="width: 100%; height: 38px" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                                    <option value="" selected disabled>Select a service</option>
                                                    @foreach ($services as $row )
                                                        <option value="{{ $row->id }}" {{ $row->id == $seller->service2 ? 'selected' : '' }} >{{ $row->title  }}</option>
                                                    @endforeach
                                                </select>
                                                @error('service2')
                                                    <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="col-md-4" data-select2-id="8">
                                            <div class="form-group" data-select2-id="7">
                                                ...
                                                <select class="custom-select2 form-control select2-hidden-accessible" name="service3" id="service3" style="width: 100%; height: 38px" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                                    <option value="" selected disabled>Select a service</option>
                                                    @foreach ($services as $row )
                                                        <option value="{{ $row->id }}" {{ $row->id == $seller->service3 ? 'selected' : '' }} >{{ $row->title  }}</option>
                                                    @endforeach
                                                </select>
                                                @error('service3')
                                                    <span class="text-danger">{{ $message }}</span>
